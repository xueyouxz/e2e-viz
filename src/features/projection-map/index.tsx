...
import { preloadProjectionMapData, useProjectionMapData } from './data/useProjectionMapData'
...
void Promise.allSettled([preloadProjectionMapData(), glyphAtlasLoader.load()])
